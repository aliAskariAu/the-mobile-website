...
<html lang="en">
  <head>
    ...
    <title>Sign-up || The Mobile Hour</title>
  </head>
              ...
              <div class="card" style="border-radius: 15px">
                <div class="card bg-white shadow-lg">
                  <div class="card-body p-5">
                    ...
                    <form enctype="multipart/form-data" action="../controller/add_user.php" method="POST">
                      ...
                      <div class="form-outline mb-3">
                        ...
                        <label class="form-label" for="user_password">
                          Password needs to be a minimum of 8 characters and
                          needs to include upper- and lower case, numbers and
                          special characters.
                        </label>
                      </div>
                      ...
                      >
                        ...
                        <label class="form-check-label" for="terms_checkbox" >
                          I agree with the
                          <a href="termsconditions.html" class="text-body"
                      ...
                      <p class="text-center text-muted mt-1 mb-0">
                        ...
                        <a href="../view/login.php" class="fw-bold text-body"
                          ><u>Login here</u></a
                        >
                      </p>
                    </form>
