...
<html lang="en">
  <head>
    ...
    <title>Login || The Mobile Hour</title>
  </head>
          ...
          <div class="col-12 col-md-8 col-lg-6">
            ...
            <div class="card bg-white shadow-lg">
              <div class="card-body p-5">
                <form enctype="multipart/form-data" action="../controller/authentication.php" method="POST">
                  <h4 class="mb-5">
                  ...
                  <p class="small">
                    <a class="text-dark" href="forget-password.html"
                      >Forgot password?</a
                    >
                  </p>
                  ...
                  <div>
                    <p class="mb-0 mt-o text-center">
                      Don't have an account?
                      <a href="sign-up.php" class="text-dark fw-bold"
                        >Sign Up</a
                      >
                    </p>
                  </div>
