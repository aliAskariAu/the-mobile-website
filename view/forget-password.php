...
<html lang="en">
  <head>
    ...
    <title>Forgot Password || The Mobile Hour</title>
  </head>
  ...
  <body>
    ...
    <div class="container d-flex flex-column">
      <div class="row align-items-center justify-content-center min-vh-100 g-0">
        <div class="col-12 col-md-8 col-lg-4 border-top border-3 border-dark">
          <div class="card bg-white shadow-lg">
            <div class="card-body p-5">
              <div class="mb-4">
                <h4>Forgot Password?</h4>
                <p class="mb-2">
                  Please enter your email below and you will receive an email to
                  reset your password
                </p>
              </div>
              <form>
